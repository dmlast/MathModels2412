...
**Курс:** математическое моделирование (ИТМО)  
...
1. **История и интуиция**
   ...
   - Ключевая идея Итô: почему появляется «лишний» член и почему \((dW_t)^2 \sim dt\)
...
| Квадратичная вариация \(\sum (\Delta W)^2 \to T\) (интуиция Итô) | ![](figs/history/ito_qv.gif) |
...
* **`ValueError: Unknown symbol: \tfrac` (matplotlib)** — заменяйте `\tfrac` на `\frac`.
